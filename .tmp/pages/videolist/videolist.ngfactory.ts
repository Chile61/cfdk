...
var renderType_videolistPage_Host:import0.RenderComponentType = (null as any);
class _View_videolistPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _videolistPage_0_4:import3.videolistPage;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_videolistPage_Host0,renderType_videolistPage_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-videolist',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_videolistPage0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    compView_0.create(this._videolistPage_0_4,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.videolistPage) && (0 === requestNodeIndex))) { return this._videolistPage_0_4; }
    return notFoundResult;
  }
}
function viewFactory_videolistPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_videolistPage_Host === (null as any))) { (renderType_videolistPage_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,[],{})); }
  return new _View_videolistPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const videolistPageNgFactory:import10.ComponentFactory<import3.videolistPage> = new import10.ComponentFactory<import3.videolistPage>('page-videolist',viewFactory_videolistPage_Host0,import3.videolistPage);
const styles_videolistPage:any[] = [];
var renderType_videolistPage:import0.RenderComponentType = (null as any);
class _View_videolistPage0 extends import1.AppView<import3.videolistPage> {
  _el_0:any;
  ...
  /*private*/ _expr_3:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_videolistPage0,renderType_videolistPage,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
...
export function viewFactory_videolistPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.videolistPage> {
  if ((renderType_videolistPage === (null as any))) { (renderType_videolistPage = viewUtils.createRenderComponentType('/Users/apple/Desktop/github/cfdk/.tmp/pages/videolist/videolist.html',0,import9.ViewEncapsulation.None,styles_videolistPage,{})); }
