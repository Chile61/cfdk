...
var renderType_videoPage_Host = null;
var _View_videoPage_Host0 = (function (_super) {
    __extends(_View_videoPage_Host0, _super);
    function _View_videoPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_videoPage_Host0, renderType_videoPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_videoPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-video', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_videoPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._videoPage_0_4 = new import3.videoPage(this.parentInjector.get(import8.NavController));
        this._appEl_0.initComponent(this._videoPage_0_4, [], compView_0);
        compView_0.create(this._videoPage_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_videoPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.videoPage) && (0 === requestNodeIndex))) {
            return this._videoPage_0_4;
        }
        return notFoundResult;
    };
    return _View_videoPage_Host0;
}(import1.AppView));
function viewFactory_videoPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_videoPage_Host === null)) {
        (renderType_videoPage_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_videoPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var videoPageNgFactory = new import10.ComponentFactory('page-video', viewFactory_videoPage_Host0, import3.videoPage);
var styles_videoPage = [];
var renderType_videoPage = null;
var _View_videoPage0 = (function (_super) {
    __extends(_View_videoPage0, _super);
    function _View_videoPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_videoPage0, renderType_videoPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_videoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this.renderer.setElementAttribute(this._el_11, 'style', 'width:640px;margin:30px auto');
        this._text_12 = this.renderer.createText(this._el_11, '\n        ', null);
        this._el_13 = this.renderer.createElement(this._el_11, 'video', null);
        this.renderer.setElementAttribute(this._el_13, 'class', 'video-js vjs-default-skin');
        this.renderer.setElementAttribute(this._el_13, 'controls', '');
        this.renderer.setElementAttribute(this._el_13, 'data-setup', '{}');
        this.renderer.setElementAttribute(this._el_13, 'height', '264');
        this.renderer.setElementAttribute(this._el_13, 'id', 'example_video_1');
        this.renderer.setElementAttribute(this._el_13, 'poster', 'http://assets.jq22.com/plugin/2015-08-25-23-08-04.jpg');
        this.renderer.setElementAttribute(this._el_13, 'preload', 'none');
        this.renderer.setElementAttribute(this._el_13, 'width', '640');
        this._text_14 = this.renderer.createText(this._el_13, '\n    ', null);
        this._el_15 = this.renderer.createElement(this._el_13, 'source', null);
        this.renderer.setElementAttribute(this._el_15, 'src', 'http://vjs.zencdn.net/v/oceans.mp4');
        this.renderer.setElementAttribute(this._el_15, 'type', 'video/mp4');
    ...
    _View_videoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_videoPage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_videoPage0.prototype.destroyInternal = function () {
        this._Content_9_4.ngOnDestroy();
    };
    return _View_videoPage0;
}(import1.AppView));
export function viewFactory_videoPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_videoPage === null)) {
        (renderType_videoPage = viewUtils.createRenderComponentType('/Users/apple/Desktop/github/cfdk/.tmp/pages/video/video.html', 0, import9.ViewEncapsulation.None, styles_videoPage, {}));
    }
    return new _View_videoPage0(viewUtils, parentInjector, declarationEl);
}
