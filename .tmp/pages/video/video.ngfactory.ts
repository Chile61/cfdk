...
var renderType_videoPage_Host:import0.RenderComponentType = (null as any);
class _View_videoPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _videoPage_0_4:import3.videoPage;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_videoPage_Host0,renderType_videoPage_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-video',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_videoPage0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    compView_0.create(this._videoPage_0_4,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.videoPage) && (0 === requestNodeIndex))) { return this._videoPage_0_4; }
    return notFoundResult;
  }
}
function viewFactory_videoPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_videoPage_Host === (null as any))) { (renderType_videoPage_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,[],{})); }
  return new _View_videoPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const videoPageNgFactory:import10.ComponentFactory<import3.videoPage> = new import10.ComponentFactory<import3.videoPage>('page-video',viewFactory_videoPage_Host0,import3.videoPage);
const styles_videoPage:any[] = [];
var renderType_videoPage:import0.RenderComponentType = (null as any);
class _View_videoPage0 extends import1.AppView<import3.videoPage> {
  _el_0:any;
  ...
  /*private*/ _expr_3:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_videoPage0,renderType_videoPage,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_13 = this.renderer.createElement(this._el_11,'video',(null as any));
    ...
    this._el_15 = this.renderer.createElement(this._el_13,'source',(null as any));
...
export function viewFactory_videoPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.videoPage> {
  if ((renderType_videoPage === (null as any))) { (renderType_videoPage = viewUtils.createRenderComponentType('/Users/apple/Desktop/github/cfdk/.tmp/pages/video/video.html',0,import9.ViewEncapsulation.None,styles_videoPage,{})); }
