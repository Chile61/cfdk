...
var _View_ContactPage0 = (function (_super) {
    ...
    _View_ContactPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_7 = this.renderer.createText(this._el_6, ' 厨房信箱', null);
        ...
        var compView_12 = import22.viewFactory_Content0(this.viewUtils, this.injector(12), this._appEl_12);
    ...
    _View_ContactPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import14.Icon) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 7)))) {
            return this._Icon_6_3;
        }
        if (((token === import13.ToolbarTitle) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 8)))) {
            return this._ToolbarTitle_4_4;
        }
        if (((token === import12.Navbar) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 9)))) {
            return this._Navbar_2_4;
        }
        if (((token === import11.Header) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 10)))) {
            return this._Header_0_3;
        }
        if (((token === import15.Content) && ((12 <= requestNodeIndex) && (requestNodeIndex <= 13)))) {
    ...
    _View_ContactPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_4 = this._Icon_6_3._hidden;
        if (import4.checkBinding(throwOnChange, this._expr_4, currVal_4)) {
            this.renderer.setElementClass(this._el_6, 'hide', currVal_4);
            this._expr_4 = currVal_4;
        }
        var currVal_5 = this._Content_12_4._sbPadding;
...
export function viewFactory_ContactPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ContactPage === null)) {
        (renderType_ContactPage = viewUtils.createRenderComponentType('/Users/apple/Desktop/github/cfdk/.tmp/pages/contact/contact.html', 0, import9.ViewEncapsulation.None, styles_ContactPage, {}));
    }
